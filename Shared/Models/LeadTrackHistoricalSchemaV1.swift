...
/// Frozen copy of the first released versioned schema (`d602f8b`).
///
/// Keep these declarations independent from the app's current model types:
/// migration source schemas must continue to describe the store that shipped,
/// even after the live models evolve.
enum LeadTrackHistoricalSchemaV1: VersionedSchema {
